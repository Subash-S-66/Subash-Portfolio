...
app.use(helmet())
app.use(cors({
  origin: process.env.CLIENT_URL || 'https://subash-s-66.github.io',
  credentials: true
}))
...
const createTransporter = () => {
  return nodemailer.createTransporter({
    service: 'gmail',
    auth: {
      user: process.env.EMAIL_USER || 'subash.93450@gmail.com',
      pass: process.env.EMAIL_PASS || 'zwdi uvfc tqfn tzmz'
    }
  })
}
